...
export default defineComponent({
    ...
    setup() {
        ...
        const handleSelect = ({ oldItem, newItem }) => {
            console.log('@select 改变ajax地址', oldItem, newItem);
        };
        // 键入回车或者点击🔍图标
        const handleSearch = () => {
            console.log('@search 发送ajax请求');
        };
        // 输入框书写内容
        const handleInput = value => {
            console.log('@write 修改响应数据,通过绑定一个响应式数据实现懒更新', value);
        };
        // 处理右侧icons图标族的点击事件
